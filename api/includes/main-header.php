...
<div class="search-area" style="border: 1px solid #E2E8F0; border-radius: 30px; overflow: hidden; background: #F8F9FA;">
    <form name="search" method="post" action="search-result.php" style="display: flex; align-items: center; padding: 5px 15px;">
        <div class="control-group" style="flex-grow: 1; display: flex; align-items: center;">
            <input class="search-field" placeholder="Search curated products..." name="product" required="required" style="border: none; background: transparent; padding: 10px; width: 100%; font-family: 'Inter', sans-serif;" />
