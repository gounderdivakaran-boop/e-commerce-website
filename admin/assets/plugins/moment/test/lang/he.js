...
exports["lang:he"] = {
    ...
    "from" : function (test) {
        ...
        test.equal(start.from(moment([2007, 1, 28]).add({m: 90}), true),  "??????",       "90 minutes = 2 hours");
        ...
        test.equal(start.from(moment([2007, 1, 28]).add({h: 36}), true),  "??????",        "36 hours = 2 days");
        ...
        test.equal(start.from(moment([2007, 1, 28]).add({d: 46}), true),  "???????",      "46 days = 2 months");
        test.equal(start.from(moment([2007, 1, 28]).add({d: 74}), true),  "???????",      "75 days = 2 months");
        ...
        test.equal(start.from(moment([2007, 1, 28]).add({d: 548}), true), "??????",       "548 days = 2 years");
